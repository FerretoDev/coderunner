...
class TestGuardarPuntaje:
    ...
    def test_persistencia_archivo(self, salon_fama_test):
        ...
        assert "registros" in data, "El archivo debe contener clave 'registros'"
...
class TestReiniciarSalonFama:
    ...
    def test_archivo_vacio_despues_limpiar(self, salon_fama_test, registros_ejemplo):
        ...
        assert data["registros"] == [], "El archivo debe tener lista de registros vacía"
...
class TestPersistenciaDatos:
    ...
    def test_carga_datos_existentes(self, tmp_path):
        ...
        # Crear archivo con datos en el formato correcto
        datos_iniciales = {
            "registros": [
                {"nombre_jugador": "Player1", "puntaje": 100, "laberinto": "lab1"}
            ]
        }
